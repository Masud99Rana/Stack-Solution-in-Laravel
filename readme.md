...
## About The Project
Stack Solution is a question and answer system for professional and enthusiast programmers. I have developed this project inspired by Stack Overflow.
...
* User can posts and answer the question
* User can vote on answer
* User can select best reply
* User can filter the posts
...
1. Clone the repo
```sh
git clone https://github.com/Masud99Rana/Stack-Solution-in_Laravel.git
```
